    ...
    <Modal
      ...
      content={
        <>
          ...
          <select
            className="my-1 bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder:text-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
          ...
          {props.transcriber.multilingual && (
            <>
              ...
              <select
                className="mt-1 mb-3 bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder:text-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
...
function RecordTile(props: {
  ...
  return (
    <div className="size-full hover:bg-[#f5f5f4] border-b-primary border-b-2">
      <Tile icon={props.icon} text={props.text} onClick={onClick} />
